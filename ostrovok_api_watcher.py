"""
Мониторинг изменений API Ostrovok.

Функции:
  - Обнаружение кандидатов на новый эндпоинт (по ключевым словам в JSON-ответах)
  - Детекция дрейфа схемы (пропавшие / новые ключи)
  - Сохранение debug-дампов при аномалиях
  - Обновление рабочей схемы после успешного парсинга
"""
